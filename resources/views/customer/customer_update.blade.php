...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <input class="form-control" name="channel" type="text" required value="{!!$customer->channel!!}">
    </div>
    <label class="col-sm-1 control-label">ประเภท</label>
    <div class="col-sm-2">
        <input class="form-control" name="type" type="text" required value="{!!$customer->type!!}">
    </div>
