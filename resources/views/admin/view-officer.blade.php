<div class="user-data-block">
    ...
    <div class="user-detail">
		<div class="row">
    		<div class="col-md-4"><div class="form-group"><b>{!!  __('messages.name') !!} :</b></div></div>
    		<div class="col-md-8"><div class="form-group">{!! $member->name !!}</div></div>
		</div>
		<div class="row">
    		<div class="col-md-4"><div class="form-group"><b>{!!  __('messages.email') !!} :</b></div></div>
    		<div class="col-md-8"><div class="form-group">{!! $member->email !!}</div></div>
		</div>
		<div class="row">
    		<div class="col-md-4"><div class="form-group"><b>{!!  __('messages.dob') !!} :</b></div></div>
    		<div class="col-md-8"><div class="form-group"><?php echo ($member->dob == null)?"-":date("j F Y",strtotime($member->dob)); ?></div></div>
		</div>
		<div class="row">
    		<div class="col-md-4"><div class="form-group"><b>{!!  __('messages.tel') !!} :</b></div></div>
    		<div class="col-md-8"><div class="form-group"><?php echo ($member->phone == null)?"-":$member->phone; ?></div></div>
		</div>
		<div class="row">
    		<div class="col-md-4"><div class="form-group"><b>{!!  __('messages.regis_date') !!} :</b></div></div>
